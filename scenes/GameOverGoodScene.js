...
export class GameOverGoodScene extends Phaser.Scene{
    constructor(){
        super({
            key: ActiveScene.AvailableScenes.GameOverGood
        })
    }
    ...
    create(){
        ...
        let title = this.add.text(width*0.3, height*0.05 , "You Chose Safety!", {font: "17px monospace", color: "white"}).setShadow(5, 5, "#5588EE", 0, true, true).setScale(3).setResolution(5);
